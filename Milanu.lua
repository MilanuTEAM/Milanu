...
if text and text:match('^'..(DevAbs:get(Milanu..'Abs:NameBot') or "ريكس")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(Milanu..'Abs:NameBot') or "ريكس")..' ','')
end
...
local BotName = (DevAbs:get(Milanu.."Abs:NameBot") or 'ريكس')
...
if text and text == (DevAbs:get(Milanu..'Abs:NameBot') or 'ريكس') then 
NameBot = (DevAbs:get(Milanu..'Abs:NameBot') or 'ريكس')
...
if text == 'تحويل' and not DevAbs:get(Milanu..'Abs:Thwel:Abs'..msg.chat_id_) and ChCheck(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
function MilanuTEAM(extra,abbas,success)
...
if text and text:match("^انطق (.*)$") and not DevAbs:get(Milanu..'Abs:Antk:Abs'..msg.chat_id_) and ChCheck(msg) then
...
if text == "غنيلي" and not DevAbs:get(Milanu..'Abs:Audios:Abs'..msg.chat_id_) and ChCheck(msg) then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/MilanuTEAM/MilanuFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/MilanuTEAM/MilanuFiles/master/MilanuFiles/"..FileName)
if Res == 200 then
