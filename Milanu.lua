...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'ميلانو')
send(msg.chat_id_, msg.id_,'*اسمي '..Namebot..'* ','*انت البوت لك 😒💔*','*لتكول بوت اسمي'..Namebot..' 😒🔪*','*عندي اسم تره 😒💔*','*صيحولي '..Namebot..' كافي بوت 😒🔪*')
end
...
gk = https.request('https://apiAlsh.ml/brg.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
