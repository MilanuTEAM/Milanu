...
✵ م6 ↫ اوامر الاعضاء
┉ ༄ ┉ ༄ ┉ ༄ ┉ ༄ ┉
✵ [S𝙾𝚞𝚁𝙲𝙴 𝙼𝙴𝙻𝙰𝙽𝙾˼](https://t.me/STEVNBOT6)
]] 
keyboard = {} 
...
De_Alsh(msg.chat_id_, msg.id_, 1, '['..MilanuTEAM[math.random(#MilanuTEAM)]..']' , 1, 'md')  
end
end
...
De_Alsh(msg.chat_id_, msg.id_, 1, MilanuTEAM[math.random(#MilanuTEAM)] , 1, 'html') 
return false
end
...
De_Alsh(msg.chat_id_, result.id_, 1,''..MilanuTEAM[math.random(#MilanuTEAM)], 1, 'html') 
else  
...
De_Alsh(msg.chat_id_, result.id_, 1,''..MilanuTEAM[math.random(#MilanuTEAM)], 1, 'md') 
end 
