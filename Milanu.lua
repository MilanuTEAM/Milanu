...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MilanuTEAM/MilanuFiles/main/File_Bot/commands.lua") 
...
if DevMilanuW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MilanuTEAM/MilanuFiles/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MilanuTEAM/MilanuFiles/main/File_Bot/"..file)
if res == 200 then
